...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('chesspuzzles_core_path', null,
                    $modx->getOption('core_path') . 'components/chesspuzzles/') . 'model/';
            $modx->addPackage('chesspuzzles', $modelPath);
            ...
            $schemaFile = MODX_CORE_PATH . 'components/chesspuzzles/model/schema/chesspuzzles.mysql.schema.xml';
